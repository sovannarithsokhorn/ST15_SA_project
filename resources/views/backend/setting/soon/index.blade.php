  ...
  max-width: 200px; /* Adjust the max-width based on your table design */
     ...
     <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Coming Soon LIST</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Coming Soon Table</h3>
                    ...
                    <div class="card-tools">
                      <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            <a href="{{url('bsoon/create')}}" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-square"></i>  Create CS-Moive
                            </a>
                        </div>
                      </div>
                    </div>
                        ...
                        @foreach ($soons as $key => $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('bsoon/'.$value->id.'/edit')}}" class="btn btn-outline-primary"><i class="far fa-edit"></i>edit</a>
                                    <form action="{{ url('bsoon/'.$value->id) }}" method="POST" style="display: inline;">
                                      @csrf
                                      @method('DELETE')
