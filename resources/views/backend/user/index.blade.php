                    ...
                    <div class="card-tools">
                      <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            <a href="{{url('user/create')}}" type="button" class="btn btn-primary btn-block"><i class="fas fa-plus-square"></i>  Create User
                            </a>
                        </div>
                      </div>
                    </div>
                      ...
                      <tbody>
                        ...
                        @foreach ($users as $key => $value)
                            <tr>
                                <td>{{++$key}}</td>
                                <td>{{$value->name}}</td>
                                <td class="truncated-description">{{ $value->email }}</td>
                                <td>{{$value->password}}</td>
                                <td>{{$value->level}}</td>
                                <td>{{$value->language}}</td>
                                <td>
                                    <button type="button" class="btn btn-outline-info"><i class="far fa-eye"></i>view</button>
                                    <a href="{{url('user/'.$value->id.'/edit')}}" class="btn btn-outline-primary"><i class="far fa-edit"></i>edit</a>
                                    <form action="{{ url('user/'.$value->id) }}" method="POST" style="display: inline;">
                                      @csrf
                                      @method('DELETE')
